...
const AboutPage: React.FC<{ onBackToPortfolio: () => void }> = ({ onBackToPortfolio }) => {
  return (
  <div style={{fontFamily:"'Inter',-apple-system,BlinkMacSystemFont,sans-serif",lineHeight:1.6,color:'#F4F7FF',background:'#080E1A',minHeight:'100vh',WebkitFontSmoothing:'antialiased'}}>
    <style>{`
      @import url('https://fonts.googleapis.com/css2?family=Libre+Baskerville:ital,wght@0,400;1,400&family=Inter:wght@300;400;500;600&family=IBM+Plex+Mono:wght@300;400;500&display=swap');
      .abl{color:#5A9FFF;text-decoration:none;border-bottom:1px solid transparent;transition:border-color .2s}
      .abl:hover{border-bottom-color:#5A9FFF}
    `}</style>

    <header style={{position:'fixed',top:0,left:0,right:0,zIndex:1000,height:'58px',background:'rgba(8,14,26,0.92)',backdropFilter:'blur(20px)',borderBottom:'1px solid rgba(255,255,255,0.08)',display:'flex',alignItems:'center'}}>
      <div style={{width:'100%',maxWidth:'1200px',margin:'0 auto',padding:'0 32px',display:'flex',alignItems:'center',justifyContent:'space-between'}}>
        <div style={{display:'flex',alignItems:'center',gap:'12px'}}>
          <span style={{fontSize:'15px',fontWeight:600,color:'#F4F7FF'}}>AlphaKnaut</span>
          <div style={{width:'1px',height:'14px',background:'rgba(255,255,255,0.14)'}}/>
          <span style={{fontFamily:"'IBM Plex Mono',monospace",fontSize:'9px',letterSpacing:'0.12em',color:'#3A4558',textTransform:'uppercase'}}>Macro Intelligence</span>
        </div>
        <div style={{display:'flex',alignItems:'center',gap:'12px'}}>
          <button onClick={onBackToPortfolio} style={{fontFamily:"'Inter',sans-serif",fontSize:'12px',color:'#6B7A94',background:'transparent',border:'none',cursor:'pointer',padding:'6px 12px',borderRadius:'4px'}}
            onMouseOver={(e)=>{e.currentTarget.style.color='#B8C4D8'}}
            onMouseOut={(e)=>{e.currentTarget.style.color='#6B7A94'}}>Portfolio</button>
          <span style={{fontFamily:"'Inter',sans-serif",fontSize:'12px',fontWeight:500,color:'#5A9FFF',padding:'5px 14px',borderRadius:'4px',background:'rgba(45,126,255,0.08)',border:'1px solid rgba(45,126,255,0.2)'}}>About</span>
        </div>
      </div>
    </header>

    <div style={{paddingTop:'58px',borderBottom:'1px solid rgba(255,255,255,0.08)'}}>
      <div style={{maxWidth:'860px',margin:'0 auto',padding:'3.5rem 2rem 2.5rem'}}>
        <div style={{display:'flex',alignItems:'center',gap:'8px',fontFamily:"'IBM Plex Mono',monospace",fontSize:'9px',letterSpacing:'0.16em',textTransform:'uppercase',color:'#5A9FFF',marginBottom:'1.2rem'}}>
          <div style={{width:'20px',height:'1px',background:'#2D7EFF'}}/>
          The Origin Story
        </div>
        <h1 style={{fontFamily:"'Libre Baskerville',Georgia,serif",fontSize:'clamp(1.9rem,3.5vw,3rem)',fontWeight:400,lineHeight:1.15,color:'#F4F7FF',marginBottom:'0.8rem'}}>
          Building <em style={{fontStyle:'italic',color:'#B8C4D8'}}>institutional-grade</em><br/>AI for portfolio strategy
        </h1>
        <p style={{fontSize:'14px',fontWeight:300,color:'#6B7A94',maxWidth:'520px',lineHeight:1.8}}>
          A self-directed project at the intersection of Finance, Economics and AI built in six weeks from zero programming experience.
        </p>
      </div>
    </div>

    <div style={{background:'#0B1220',borderTop:'1px solid rgba(255,255,255,0.06)',borderBottom:'1px solid rgba(255,255,255,0.06)',padding:'1.8rem 2rem'}}>
      <div style={{maxWidth:'860px',margin:'0 auto'}}>
        <div style={{borderLeft:'2px solid #2D7EFF',paddingLeft:'1.5rem'}}>
          <p style={{fontFamily:"'Libre Baskerville',Georgia,serif",fontSize:'clamp(1.1rem,1.8vw,1.35rem)',fontStyle:'italic',fontWeight:400,color:'#F4F7FF',lineHeight:1.5,marginBottom:'0.8rem'}}>
            We are witnessing two classes of students emerge those who wait for access and those who build the access themselves.
          </p>
          <div style={{display:'flex',alignItems:'center',gap:'10px'}}>
            <div style={{width:'32px',height:'32px',borderRadius:'50%',background:'rgba(45,126,255,0.1)',border:'1px solid #2D7EFF',display:'flex',alignItems:'center',justifyContent:'center',fontSize:'10px',fontWeight:600,color:'#5A9FFF',flexShrink:0}}>RP</div>
            <div>
              <span style={{fontSize:'12px',fontWeight:500,color:'#F4F7FF',display:'block'}}>Riya Pradhan</span>
              <span style={{fontFamily:"'IBM Plex Mono',monospace",fontSize:'9px',color:'#3A4558',letterSpacing:'0.04em'}}>Founder · University of Toronto · Georgetown MSBA 27</span>
            </div>
          </div>
        </div>
      </div>
    ...
    <main style={{maxWidth:'860px',margin:'0 auto',padding:'2.5rem 2rem'}}>
      ...
      <div style={{borderBottom:'1px solid rgba(255,255,255,0.07)',marginBottom:'2.2rem',paddingBottom:'2.2rem'}}>
        <div style={{display:'flex',alignItems:'center',gap:'8px',fontFamily:"'IBM Plex Mono',monospace",fontSize:'9px',letterSpacing:'0.18em',textTransform:'uppercase',color:'#5A9FFF',marginBottom:'0.8rem'}}>
          <span style={{width:'14px',height:'1px',background:'#2D7EFF',display:'inline-block'}}/>The Challenge
        </div>
        <h2 style={{fontFamily:"'Libre Baskerville',Georgia,serif",fontSize:'1.45rem',fontWeight:400,color:'#F4F7FF',marginBottom:'0.8rem',lineHeight:1.2}}>Why AlphaKnaut exists</h2>
        <p style={{fontSize:'14px',fontWeight:300,color:'#6B7A94',lineHeight:1.85,marginBottom:'0.8rem'}}>In Summer 2025, I (<a href="https://www.linkedin.com/in/riya-pradhan/" target="_blank" rel="noopener noreferrer" className="abl">Riya Pradhan</a>) set out to find internships combining <strong style={{color:'#B8C4D8',fontWeight:500}}>financial economics and AI</strong> — the intersection where I plan to build my career. Such opportunities did not exist. So I built one myself.</p>
        <p style={{fontSize:'14px',fontWeight:300,color:'#6B7A94',lineHeight:1.85}}><strong style={{color:'#B8C4D8',fontWeight:500}}>The result:</strong> AlphaKnaut — a full-stack platform integrating real-time financial data, macroeconomic indicators, and AI reasoning for portfolio optimization.</p>
      </div>

      <div style={{borderBottom:'1px solid rgba(255,255,255,0.07)',marginBottom:'2.2rem',paddingBottom:'2.2rem'}}>
        <div style={{display:'flex',alignItems:'center',gap:'8px',fontFamily:"'IBM Plex Mono',monospace",fontSize:'9px',letterSpacing:'0.18em',textTransform:'uppercase',color:'#5A9FFF',marginBottom:'0.8rem'}}>
          <span style={{width:'14px',height:'1px',background:'#2D7EFF',display:'inline-block'}}/>The Platform
        </div>
        <h2 style={{fontFamily:"'Libre Baskerville',Georgia,serif",fontSize:'1.45rem',fontWeight:400,color:'#F4F7FF',marginBottom:'0.8rem',lineHeight:1.2}}>What AlphaKnaut is</h2>
        <p style={{fontSize:'14px',fontWeight:300,color:'#6B7A94',lineHeight:1.85,marginBottom:'0.8rem'}}>AlphaKnaut is an AI-powered portfolio optimization platform centered on the Magnificent 7 technology stocks ($17.4 trillion market cap, 34% of S&P 500 weight). The platform combines real-time financial data, macroeconomic indicators, news sentiment, and AI-powered reasoning to generate forward-looking portfolio insights.</p>
        <p style={{fontSize:'14px',fontWeight:300,color:'#6B7A94',lineHeight:1.85}}>The system simulates institutional-grade financial analysis through responsive data visualizations, economic forecasting, and natural language processing that adjusts to user preferences and market conditions.</p>
      </div>

      <div style={{borderBottom:'1px solid rgba(255,255,255,0.07)',marginBottom:'2.2rem',paddingBottom:'2.2rem'}}>
        <div style={{display:'flex',alignItems:'center',gap:'8px',fontFamily:"'IBM Plex Mono',monospace",fontSize:'9px',letterSpacing:'0.18em',textTransform:'uppercase',color:'#5A9FFF',marginBottom:'0.8rem'}}>
          <span style={{width:'14px',height:'1px',background:'#2D7EFF',display:'inline-block'}}/>Technical Architecture
        </div>
        <h2 style={{fontFamily:"'Libre Baskerville',Georgia,serif",fontSize:'1.45rem',fontWeight:400,color:'#F4F7FF',marginBottom:'0.8rem',lineHeight:1.2}}>How it is built</h2>
        <div style={{display:'grid',gridTemplateColumns:'repeat(auto-fit,minmax(180px,1fr))',gap:'10px',marginTop:'0.5rem'}}>
          {[{t:'Frontend',d:'React.js and TypeScript with 15 interconnected state variables and Recharts integration'},{t:'Backend',d:'Python Flask API with 12 RESTful endpoints and robust error handling'},{t:'AI Engine',d:'Anthropic Claude with custom prompt engineering and structured JSON outputs'},{t:'Data Pipeline',d:'Yahoo Finance, Federal Reserve FRED, NewsAPI, and Finnhub APIs'}].map((item,i)=>(
            <div key={i} style={{background:'#0F1828',border:'1px solid rgba(255,255,255,0.07)',borderRadius:'6px',padding:'1rem'}}>
              <div style={{fontFamily:"'IBM Plex Mono',monospace",fontSize:'9px',letterSpacing:'0.1em',textTransform:'uppercase',color:'#5A9FFF',marginBottom:'6px'}}>{item.t}</div>
              <p style={{fontSize:'12px',color:'#6B7A94',lineHeight:1.6,margin:0,fontWeight:300}}>{item.d}</p>
            </div>
          ))}
        </div>
      </div>
      ...
      <div style={{borderBottom:'1px solid rgba(255,255,255,0.07)',marginBottom:'2.2rem',paddingBottom:'2.2rem'}}>
        <div style={{display:'flex',alignItems:'center',gap:'8px',fontFamily:"'IBM Plex Mono',monospace",fontSize:'9px',letterSpacing:'0.18em',textTransform:'uppercase',color:'#5A9FFF',marginBottom:'0.8rem'}}>
          <span style={{width:'14px',height:'1px',background:'#2D7EFF',display:'inline-block'}}/>Development Process
        </div>
        <h2 style={{fontFamily:"'Libre Baskerville',Georgia,serif",fontSize:'1.45rem',fontWeight:400,color:'#F4F7FF',marginBottom:'0.8rem',lineHeight:1.2}}>Six weeks from zero</h2>
        <div style={{borderLeft:'1px solid rgba(255,255,255,0.10)',paddingLeft:'1.5rem',marginTop:'0.5rem'}}>
          {[{t:'Weeks 1-2: Foundation',d:'Learned TypeScript, React, and Python simultaneously. Mastered state management and API integration.'},{t:'Week 3: Data Integration',d:'Created pipelines for 4 external APIs with asynchronous processing and robust error handling.'},{t:'Week 4: AI Implementation',d:'Engineered prompts for market-aware financial analysis. Built unified AI engine for portfolio analysis.'},{t:'Weeks 5-6: Features and Polish',d:'Implemented 3 allocation strategies with risk monitoring and weight normalization algorithms.'}].map((item,i)=>(
            <div key={i} style={{position:'relative',marginBottom:'1.2rem'}}>
              <div style={{position:'absolute',left:'-1.75rem',top:'3px',width:'7px',height:'7px',background:'#2D7EFF',borderRadius:'50%'}}/>
              <div style={{fontSize:'12px',fontWeight:500,color:'#B8C4D8',marginBottom:'3px'}}>{item.t}</div>
              <div style={{fontSize:'12px',color:'#6B7A94',fontWeight:300,lineHeight:1.6}}>{item.d}</div>
            </div>
          ))}
        </div>
        <div style={{display:'flex',flexWrap:'wrap',gap:'6px',marginTop:'1rem'}}>
          {['Economics UofT','Python React Flask','Claude API','Macro Finance','Georgetown MSBA 27'].map((t,i)=>(
            <span key={i} style={{fontFamily:"'IBM Plex Mono',monospace",fontSize:'9px',letterSpacing:'0.06em',padding:'4px 10px',border:'1px solid rgba(255,255,255,0.08)',borderRadius:'2px',color:'#3A4558'}}>{t}</span>
          ))}
        </div>
      </div>
      ...
      <div style={{borderBottom:'1px solid rgba(255,255,255,0.07)',marginBottom:'2.2rem',paddingBottom:'2.2rem'}}>
        <div style={{display:'flex',alignItems:'center',gap:'8px',fontFamily:"'IBM Plex Mono',monospace",fontSize:'9px',letterSpacing:'0.18em',textTransform:'uppercase',color:'#5A9FFF',marginBottom:'0.8rem'}}>
          <span style={{width:'14px',height:'1px',background:'#2D7EFF',display:'inline-block'}}/>Key Learnings
        </div>
        <h2 style={{fontFamily:"'Libre Baskerville',Georgia,serif",fontSize:'1.45rem',fontWeight:400,color:'#F4F7FF',marginBottom:'0.8rem',lineHeight:1.2}}>AI reliability challenges</h2>
        <p style={{fontSize:'14px',fontWeight:300,color:'#6B7A94',lineHeight:1.85,marginBottom:'0.8rem'}}><strong style={{color:'#B8C4D8',fontWeight:500}}>The Hallucination Problem:</strong> As an LLM-powered system, Claude can generate convincing but inaccurate information. Since these models are non-deterministic by nature, the same input can produce different outputs.</p>
        <p style={{fontSize:'14px',fontWeight:300,color:'#6B7A94',lineHeight:1.85}}><strong style={{color:'#B8C4D8',fontWeight:500}}>Key Learning:</strong> The challenge is not perfecting AI output — it is building robust systems that assume AI will make mistakes. Each validation layer taught me more about practical AI deployment than any coursework could.</p>
      </div>

      <div style={{background:'#0F1828',border:'1px solid rgba(255,255,255,0.08)',borderLeft:'2px solid #2D7EFF',borderRadius:'0 8px 8px 0',padding:'1.5rem'}}>
        <div style={{fontSize:'15px',fontWeight:500,color:'#F4F7FF',marginBottom:'2px'}}>Riya Pradhan</div>
        <div style={{fontFamily:"'IBM Plex Mono',monospace",fontSize:'9px',color:'#3A4558',letterSpacing:'0.06em',marginBottom:'0.8rem'}}>University of Toronto · Incoming Georgetown MSBA 27</div>
        <p style={{fontSize:'13px',color:'#6B7A94',lineHeight:1.7,fontWeight:300,marginBottom:'0.8rem'}}>I would love to connect and chat about this project or anything related to finance and AI.</p>
        <a href="https://www.linkedin.com/in/riya-pradhan" target="_blank" rel="noopener noreferrer" style={{color:'#5A9FFF',textDecoration:'none',fontSize:'12px'}}>Connect on LinkedIn</a>
      </div>

    </main>

    <footer style={{borderTop:'1px solid rgba(255,255,255,0.08)',padding:'20px 2rem',display:'flex',alignItems:'center',justifyContent:'space-between',background:'#0B1220',marginTop:'2rem'}}>
      <span style={{fontFamily:"'IBM Plex Mono',monospace",fontSize:'10px',color:'#3A4558'}}>AlphaKnaut · Macro Intelligence</span>
      <span style={{fontFamily:"'IBM Plex Mono',monospace",fontSize:'10px',color:'#3A4558'}}>Built by Riya Pradhan</span>
    </footer>
  </div>
  );
};
